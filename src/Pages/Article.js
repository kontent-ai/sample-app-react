...
let getState = (props) => {
    return {
        article: ArticleStore.getArticle(props.params.articleCodename)
    };
};
...
class Article extends Component {
    ...
    componentDidMount() {
        ...
        ArticleStore.provideArticle(this.props.params.articleCodename);
    }
