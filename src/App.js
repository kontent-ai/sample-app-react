    ...
    return (
      <div className="application-content">
        ...
        <Switch>
          ...
          <Route path="/:lang?/brewers/:brewerSlug" render={(matchProps) => <BrewerPage {...matchProps} language={language} />} />
          <Route exact path="/:lang?/articles" render={() => <ArticlesPage language={language} />} />
          <Route path="/:lang?/articles/:articleId" render={(matchProps) => <ArticlePage {...matchProps} language={language} />} />
          <Route path="/:lang?/cafes" render={() => <CafesPage language={language} />} />
