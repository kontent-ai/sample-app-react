# Kentico Kontent sample React single-page application - Google Analytics
...
![Analytics](https://kentico-ga-beacon.azurewebsites.net/api/UA-69014260-4/Kentico/kontent-sample-app-react/samples/ga?pixel)
