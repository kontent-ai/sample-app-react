# Kentico Kontent sample React single-page application - Personalization (Optimizely)
[![Build Status](https://api.travis-ci.com/Kentico/kontent-sample-app-react.svg?branch=samples/optimizely)](https://travis-ci.com/Kentico/kontent-sample-app-react)
[![Live Demo](https://img.shields.io/badge/live-demo-brightgreen.svg)](https://kontent-sample-app-react-optimizely.surge.sh)
...
![Analytics](https://kentico-ga-beacon.azurewebsites.net/api/UA-69014260-4/Kentico/kontent-sample-app-react/samples/optimizely?pixel)
